...
- ``RegisterGeneratedFactory`` has been marked as obsolete.  You should update your code to use the ``Func<T>`` :doc:`implicit relationship <../resolve/relationships>`_  or :doc:`delegate factories <../advanced/delegate-factories>`_.
