...
:doc:`See the Native AOT and Trimming page for full guidance, including the legacy Xamarin and .NET Native tips. <../advanced/native-aot-trimming>` Getting the right compiler and linker directives in place for reflection can take some trial and error; if you have additional tips or articles to contribute that might help others, let us know and we'll be happy to include them.
